                    ...
                    <Box w="50%">
                        <VStack alignItems="flex-start" spacing="5">
                            ...
                            <Box color="grey" fontSize="14px">
                                <Box>
                                    Folders make it possbile to arrange your content in different containers. 
                                </Box>
                                <Box mt="5">
                                    A folder can be limited to only store content of a specific type of content.
                                </Box>
                            </Box>
                        </VStack>
                    </Box>
        ...
        {mode == "list" && <Container maxW="1000px">
            <VStack w="100%" spacing="10">
                <HStack w="100%" mt="20px">
                    ...
                    <Button colorScheme={"blue"} w="150px" onClick={() =>    router.push(`/portal/spaces/${params.spaceid}/content`)}>BACK</Button>
