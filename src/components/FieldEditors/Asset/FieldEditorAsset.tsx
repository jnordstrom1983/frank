...
import { GetAssetValidationSchema, ValidateAssetValue } from "./FieldEditorAssetHelper"
import { AssetEditor } from "./AssetEditor"

export function FieldEditorAsset({
    value,
    field,
    onChange,
    onValidation,
    ...
    useEffect(() => {
        const result = ValidateAssetValue(validationSchema, internalValue.length > 0 ? internalValue[0] : undefined)
